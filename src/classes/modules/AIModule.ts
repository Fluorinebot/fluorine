...
import type { CommandInteraction, MessageContextMenuInteraction } from 'tiscord';
...
export default class AIModule {
    ...
    async getAI(interaction: CommandInteraction | MessageContextMenuInteraction, text: string): Promise<void> {
    ...
    async generate(): Promise<void> {
        ...
        interaction.followUp({ embeds: [embed.toJSON()] });
