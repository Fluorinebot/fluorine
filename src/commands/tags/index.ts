...
export const data = new SlashCommandBuilder()
        ...
        subcommand
            ...
            .addBooleanOption(option =>
                option
                    .setName('ephemeral')
                    .setDescription(
                        'Whether this tag should be displayed to everyone or just the person viewing it.'
                    )
                    .setRequired(false)
            )
    )
    .addSubcommand(subcommand =>
        subcommand
            ...
            .addStringOption(option =>
                option
                    .setName('tag')
                    .setDescription('The tag to list info on')
                    .setRequired(false)
            )
    )
    .addSubcommand(subcommand =>
    ...
    .addSubcommand(subcommand =>
        subcommand
            .setName('transfer')
            .setDescription(
                'Transfer a tag from an owner who has left the server'
            )
            .addStringOption(option =>
                option
                    .setName('tag')
    ...
    .addSubcommand(subcommand =>
        subcommand
            ...
            .addStringOption(option =>
                option
                    .setName('tag')
                    .setDescription('The tag to export')
                    .setRequired(true)
            )
    );
